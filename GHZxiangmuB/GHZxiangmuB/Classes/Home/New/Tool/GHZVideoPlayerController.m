...
#import "GHZVideoPlayerControlView.h"
static const CGFloat kVideoPlayerControllerAnimationTimeinterval = 0.3f;

@interface GHZVideoPlayerController ()

@property (nonatomic, strong) GHZVideoPlayerControlView *videoControl;
...
@implementation GHZVideoPlayerController
...
- (GHZVideoPlayerControlView *)videoControl
{
    if (!_videoControl) {
        _videoControl = [[GHZVideoPlayerControlView alloc] init];
    }
